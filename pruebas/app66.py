...
# Evitar que se envíen formularios con Enter
disable_enter_js = """
<script>
...
# =============================================================================
# FUNCIONES DE ACTUALIZACIÓN EN LA BASE DE DATOS
# =============================================================================
...
def update_contact(contact_id, link_auto, telefono, nombre, auto, precio, descripcion):
    ...
    try:
        with get_connection() as con:
            cursor = con.cursor()
            # Limpiar el teléfono eliminando espacios
...
# =============================================================================
    ...
    if opcion_editar == "Editar Contactos":
        st.subheader("Editar Contactos")
        # Ingreso de búsqueda por teléfono
        phone_query = st.text_input("Ingrese parte o el número completo del teléfono")
        if phone_query:
            ...
            if df_search.empty:
                ...
                with st.form("editar_contacto_form"):
                    ...
                    submit_button = st.form_submit_button("Actualizar Contacto")
                if submit_button:
